...
var watchConfig=['sassWatch','jsWatch','htmlWatch','imgWatch','cssWatch','vmWatch'];

var packConfig=['htmlPack','imgPack','cssPack','sassPack','vmPack','jsPack'];
...
dir.src = {
  ...
  temp: path.normalize(__dirname + '/' + fileName + '/source/WEB-INF/')
};
...
dir.dist = {
  ...
  temp: path.normalize(__dirname + '/' + fileName + '/build/WEB-INF/')
};
 ...
 * 调用 m-build 函数
 */
MBuild(dir, config,watchConfig,packConfig);
