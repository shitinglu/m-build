...
const fileName = 'projectName/pageName/';
...
var watchConfig=['sassWatch','jsWatch','htmlWatch','imgWatch','cssWatch','server'];

var packConfig=['htmlPack','imgPack','cssPack','sassPack','jsPack'];
